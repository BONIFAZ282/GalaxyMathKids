...
class Planeta {
   ...
   * @param {HTMLElement} areaTrabajo - Área donde se colocará el planeta.
   * @param {HTMLElement} contenedorDialog - Contenedor del diálogo del planeta.
   * @param {number} pos_x - Posición en el eje X.
   * @param {number} pos_y - Posición en el eje Y.
   */
   ...
   * @param {Object} data - Información del planeta.
   */
...
class Astronauta {
   ...
   * @param {HTMLElement} areaTrabajo - Área donde se colocará el astronauta.
   * @param {Array} planetas - Array de planetas disponibles.
   */
   ...
   * @param {number} index - Índice del planeta al que se dirige.
   */
...
class Pregunta {
   ...
   * @param {Object} data - Información de la pregunta.
   */
