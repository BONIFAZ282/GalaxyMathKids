...
audio.volume = 0.018; // Ajustar el volumen del audio principal
correcto.volume = 0.1; // Ajustar el volumen del audio para respuestas correctas
incorrecto.volume = 0.1; // Ajustar el volumen del audio para respuestas incorrectas
